...
export default function ProfileContents() {
  return (
    <div className="mt-16">
      <MotionUpDiv className="text-profile after-primary-dot" delay={0}>
        웹 프론트엔드 2년차
      </MotionUpDiv>
      <MotionUpDiv className="text-profile after-primary-dot" delay={0.4}>
        모바일 게임 클라이언트 10년차
      </MotionUpDiv>
      <MotionUpDiv className="mt-5 text-profileContents" delay={1}>
      ...
      <MotionUpDiv className="mt-5 text-profileContents" delay={1.2}>
      ...
      <MotionUpDiv className="mt-5 text-profileContents" delay={1.4}>
      ...
      <MotionUpDiv className="mt-5 text-profileContents" delay={1.6}>
